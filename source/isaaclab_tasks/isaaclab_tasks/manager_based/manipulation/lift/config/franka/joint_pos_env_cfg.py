        ...
        self.scene.object_pool = RigidObjectCollectionCfg(
            rigid_objects={
                ...
                "baisetuoxie": RigidObjectCfg(
                    ...
                    spawn=sim_utils.UsdFileCfg(
                        usd_path="/home/roborock/data/private/shengmei_1/IsaacLab/assets/baisetuoxie_yonghan/baisetuoxie.usdc",
                        scale=(1.0, 1.0, 1.2),
                        rigid_props=sim_utils.RigidBodyPropertiesCfg(
                            solver_position_iteration_count=64,
                ...
                #     spawn=sim_utils.UsdFileCfg(
                #         usd_path="/home/roborock/gitlab5/drl_manipulation/assets/fensemiantuo/fensemiantuo.usdc",
                #         scale=(1.0, 1.0, 1.0),
                #         rigid_props=sim_utils.RigidBodyPropertiesCfg(
                #             solver_position_iteration_count=64,
                #             solver_velocity_iteration_count=32,
