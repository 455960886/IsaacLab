...
def copy_files_with_keyword(src_dir, dst_dir, keyword):
    ...
    :param src_dir: 源目录路径，如 //home/robo/code/IsaacLab/assets1/3D_assets_usd/floor
...
if __name__ == "__main__":
    src_folder = "/home/robo/code/IsaacLab/assets1/3D_assets_usd/floor"  # 你的源目录
    dst_folder = "/home/robo/code/IsaacLab/assets1/3D_assets_usd/floor/dataset"  # 你想复制到这里
