import sys
sys.path.append("/home/robo/code/IsaacLab/source/isaaclab")
...
input1 = prepare_input("/home/robo/code/IsaacLab/frame_1.ply")
...
# 1️⃣ 加载预训练模型
img = load_image("/home/robo/code/Downloads/real.png")
