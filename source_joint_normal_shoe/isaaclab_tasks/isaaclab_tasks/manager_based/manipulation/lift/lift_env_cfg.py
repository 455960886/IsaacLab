...
class ActionsCfg:
    ...
    arm_action: mdp.RelativeJointPositionActionCfg | mdp.DifferentialInverseKinematicsActionCfg | mdp.JointPositionActionCfg | mdp.EMAJointPositionActionCfg = MISSING
...
class ResNet18ObservationCfg:
    ...
    class ResNet18FeaturesCameraPolicyCfg(ObsGroup):
        ...
        joint_pos = ObsTerm(
            func=mdp.joint_pos_normalized_with_binary_m6_latched,
            params={
...
class EventCfg:
    ...
    reset_object_position_slippers_m5_top1 = EventTerm(
        ...
        params={
            ...
            "yaw_ranges": [(-0.6, 0.0), (-6.28, -5.48)],  # Two separate yaw ranges to encourage top-down and side orientations
            # "yaw_ranges": [(-1.0, 0.0)],
            "velocity_range": {},
            "asset_cfg": SceneEntityCfg("object_pool"),
        },
