...
class ResNet18ObservationCfg:
    ...
    class CriticPrivilegedObsCfg(ObsGroup):
        ...
        #     params={"asset_cfg": SceneEntityCfg("robot", joint_names=["M[345]", "M6_.*"])},
        # )
        # active_object_position = ObsTerm(
        #     func=mdp.active_object_position_in_robot_root_frame,
        #     params={
        #         "robot_cfg": SceneEntityCfg("robot"),
        #         "object_cfg": SceneEntityCfg("object_pool"),
        #     },
        # )
        # object_yaw_sincos = ObsTerm(
        #     func=mdp.active_object_yaw_sincos,
        #     params={"object_cfg": SceneEntityCfg("object_pool")},
        # )
        # active_object_id = ObsTerm(
        #     func=mdp.active_object_id_onehot,
        #     params={"object_cfg": SceneEntityCfg("object_pool")},
        # )
        # active_object_scale = ObsTerm(
        #     func=mdp.active_object_scale,
        #     params={"object_cfg": SceneEntityCfg("object_pool")},
        # )
        # gripper_contact = ObsTerm(
        #     func=mdp.gripper_contact_y_force,
        #     params={
...
class EventCfg:
    ...
    # log_critic_observation_summary = EventTerm(
    #     func=mdp.log_observation_group_summary,
    #     mode="reset",
    #     params={
    #         "group_name": "critic",
    #         "sample_env_id": 0,
    #         "once": True,
    #         "max_elements_per_term": 16,
    #     },
    # )
