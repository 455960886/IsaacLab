...
MY_ROBOT_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"/home/roborock/data/private/shengmei/IsaacLab/_isaac_sim/assets/r50_v6_rev/r50_v6_rev_flat_finger.usd",
        ...
        self.scene.object_pool = RigidObjectCollectionCfg(
            rigid_objects={
                "lego": RigidObjectCfg(
                    ...
                    spawn=sim_utils.UsdFileCfg(
                        usd_path="/home/roborock/data/private/shengmei/IsaacLab/_isaac_sim/assets/lego_gongzixing.usdc",
                        scale=(4.0, 4.0, 8.0),
                        rigid_props=sim_utils.RigidBodyPropertiesCfg(
