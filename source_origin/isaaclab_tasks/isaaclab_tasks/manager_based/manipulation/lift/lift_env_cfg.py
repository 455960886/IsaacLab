...
class EventCfg:
    ...
    randomize_floor = EventTerm(
        ...
        mode="reset",
        params={
            "texture_txt_path": "/home/roborock/data/private/shengmei/IsaacLab/_isaac_sim/assets/Floor/floor.txt"
        },
    )
...
class LiftEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: ObjectTableSceneCfg = ObjectTableSceneCfg(num_envs=256, env_spacing=3)
