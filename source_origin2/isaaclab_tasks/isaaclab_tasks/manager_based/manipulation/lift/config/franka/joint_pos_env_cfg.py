...
MY_ROBOT_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        "hand": ImplicitActuatorCfg(
            ...
            damping=0.0001,           # Increased from 0.001 for better stability
        ),
    ...
    def __post_init__(self):
        ...
        self.scene.object_pool = RigidObjectCollectionCfg(
            rigid_objects={
                ...
                #     spawn=sim_utils.UsdFileCfg(
                #         usd_path="/home/roborock/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/manipulation/lift/robot_model/arm_description/urdf/R50/assets/lego_gongzixing.usdc",
                #         scale=(1.0, 2.0, 1.0),
                #         rigid_props=sim_utils.RigidBodyPropertiesCfg(
                #             solver_position_iteration_count=64,
                #             solver_velocity_iteration_count=16,
