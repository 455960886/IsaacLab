...
class RewardsCfg:
    ...
    lifting_object_linear = RewTerm(
        ...
        params={"minimal_height": 0.02, "max_height": 0.06},
        weight=300.0,   # 1500  150
    )
...
class LiftEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: ObjectTableSceneCfg = ObjectTableSceneCfg(num_envs=8, env_spacing=7)
