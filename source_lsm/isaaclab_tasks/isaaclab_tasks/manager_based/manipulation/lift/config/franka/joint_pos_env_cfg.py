        ...
        self.scene.object_pool = RigidObjectCollectionCfg(
            rigid_objects={
                "bus": RigidObjectCfg(
                    ...
                    spawn=sim_utils.UsdFileCfg(
                        usd_path="/home/robo/下载/bus_2.usd",
                ...
                "PaperBall": RigidObjectCfg(
                    ...
                    spawn=sim_utils.UsdFileCfg(
                        usd_path="/home/robo/code/IsaacLab/assets1/3D_assets_usd/paperball.usdc",
                        scale=(0.8, 0.8, 1.2),
                        rigid_props=sim_utils.RigidBodyPropertiesCfg(
                            solver_position_iteration_count=64,
                            solver_velocity_iteration_count=64,
                    ...
                    init_state=RigidObjectCfg.InitialStateCfg(pos=[0.25, 0.01, 0.0]),
                ),
            }
        )
