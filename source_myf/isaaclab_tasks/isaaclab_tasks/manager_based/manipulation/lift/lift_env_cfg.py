...
class EventCfg:
    ...
    randomize_floor = EventTerm(
        ...
        mode="reset",
        params={
            "texture_txt_path" :"/home/roborock/data/private/shengmei/IsaacLab/assets1/3D_assets_usd/floor.txt"
        },
    )
...
class LiftEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: ObjectTableSceneCfg = ObjectTableSceneCfg(num_envs=156, env_spacing=2.5)
    # Basic settings
