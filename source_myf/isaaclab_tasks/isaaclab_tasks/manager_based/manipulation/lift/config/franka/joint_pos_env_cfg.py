...
MY_ROBOT_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path=f"/home/roborock/data/private/shengmei/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/manipulation/lift/robot_model/arm_description/urdf/R50_1/r50_v6_rev/r50_v6_rev.usd",
        ...
        self.scene.object_pool = RigidObjectCollectionCfg(
            rigid_objects={
                ...
                "Object_8": RigidObjectCfg(
                    ...
                    spawn=sim_utils.UsdFileCfg(
                        usd_path="/home/roborock/data/private/shengmei/IsaacLab/assets1/3D_assets_usd/lego_1.usd",
                        scale=(1.0, 2.0, 1.0),
                        rigid_props=sim_utils.RigidBodyPropertiesCfg(
                            solver_position_iteration_count=64,
                            solver_velocity_iteration_count=32,
                ...
                #     spawn=sim_utils.UsdFileCfg(
                #         usd_path="/home/roborock/data/private/shengmei/IsaacLab/assets1/3D_assets_usd/paperball.usdc",
                #         scale=(0.8, 0.8, 1.2),
                #         rigid_props=sim_utils.RigidBodyPropertiesCfg(
                #             solver_position_iteration_count=64,
                #             solver_velocity_iteration_count=64,
